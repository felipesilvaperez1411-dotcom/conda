...
with open("respuestas_reto.txt", "w", encoding="utf-8") as f:
    f.write("Resumen de respuestas del reto\n\n")
    for nombre, respuesta in respuestas:
        f.write(f"{nombre} respondió: {respuesta}\n")

print("\n¡Gracias por participar! Las resp
